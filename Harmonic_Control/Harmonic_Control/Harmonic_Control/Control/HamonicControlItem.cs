...
namespace Harmonic_Control
{
    class HamonicControlItem
    {
        ...
        public string SOCKET_IP1 = "192.168.137.214";
        ...
        public bool HamonicItemSetting(string itemName, int command)
        {
            ...
            {
                return socketClientManager.SendON_OFF_Command(SOCKET_IP2, SOCKET_PORT2, command, itemName);
            }
            else if (itemName == ITEMCONTROL3)
            {
                return socketClientManager.SendON_OFF_Command(SOCKET_IP3, SOCKET_PORT3, command, itemName);

            }
            else if (itemName == ITEMCONTROL4)
            {
                return socketClientManager.SendON_OFF_Command(SOCKET_IP4, SOCKET_PORT4, command, itemName);
            }
            else if (itemName == ITEMCONTROL5)
            {
                return socketClientManager.SendON_OFF_Command(SOCKET_IP5, SOCKET_PORT5, command, itemName);
            }
            else if (itemName == ITEMCONTROL6)
            {
                return socketClientManager.SendON_OFF_Command(SOCKET_IP6, SOCKET_PORT6, command, itemName);

            }
            else if (itemName == ITEMCONTROL7)
            {
                return socketClientManager.SendON_OFF_Command(SOCKET_IP7, SOCKET_PORT7, command, itemName);
            }
            else if (itemName == ITEMCONTROL8)
            {
                return socketClientManager.SendON_OFF_Command(SOCKET_IP8, SOCKET_PORT8, command, itemName);
            }
            else if (itemName == ITEMCONTROL9)
            {
                return socketClientManager.SendON_OFF_Command(SOCKET_IP9, SOCKET_PORT9, command, itemName);
            }
            else if (itemName == ITEMCONTROL10)
            {
                return socketClientManager.SendON_OFF_Command(SOCKET_IP10, SOCKET_PORT10, command, itemName);
            }
            else if (itemName == ITEMCONTROL11)
            {
                return socketClientManager.SendON_OFF_Command(SOCKET_IP11, SOCKET_PORT11, command, itemName);
            }
            else if (itemName == ITEMCONTROL12)
            {
                return socketClientManager.SendON_OFF_Command(SOCKET_IP12, SOCKET_PORT12, command, itemName);
            }
            else if (itemName == ITEMCONTROL13)
            {
                return socketClientManager.SendON_OFF_Command(SOCKET_IP13, SOCKET_PORT13, command, itemName);
            }
            else if (itemName == ITEMCONTROL14)
            {
                return socketClientManager.SendON_OFF_Command(SOCKET_IP14, SOCKET_PORT14, command, itemName);
            }
            else if (itemName == ITEMCONTROL15)
            {
                return socketClientManager.SendON_OFF_Command(SOCKET_IP15, SOCKET_PORT15, command, itemName);
            }
            else if (itemName == ITEMCONTROL16)
            {
                return socketClientManager.SendON_OFF_Command(SOCKET_IP16, SOCKET_PORT16, command, itemName);
            }
            else
                return false;
        }
        public int HamonicItemCheckStatus(string itemName, int command) {
            if (itemName == ITEMCONTROL1)
            {
                return socketClientManager.CheckHamonic_Status(SOCKET_IP1, SOCKET_PORT1, command, itemName);
            }
            else if (itemName == ITEMCONTROL2)
            {
                return socketClientManager.CheckHamonic_Status(SOCKET_IP2, SOCKET_PORT2, command, itemName);
            }
            else if (itemName == ITEMCONTROL3)
            {
                return socketClientManager.CheckHamonic_Status(SOCKET_IP3, SOCKET_PORT3, command, itemName);

            }
            else if (itemName == ITEMCONTROL4)
            {
                return socketClientManager.CheckHamonic_Status(SOCKET_IP4, SOCKET_PORT4, command, itemName);
            }
            else if (itemName == ITEMCONTROL5)
            {
                return socketClientManager.CheckHamonic_Status(SOCKET_IP5, SOCKET_PORT5, command, itemName);
            }
            else if (itemName == ITEMCONTROL6)
            {
                return socketClientManager.CheckHamonic_Status(SOCKET_IP6, SOCKET_PORT6, command, itemName);

            }
            else if (itemName == ITEMCONTROL7)
            {
                return socketClientManager.CheckHamonic_Status(SOCKET_IP7, SOCKET_PORT7, command, itemName);
            }
            else if (itemName == ITEMCONTROL8)
            {
                return socketClientManager.CheckHamonic_Status(SOCKET_IP8, SOCKET_PORT8, command, itemName);
            }
            else if (itemName == ITEMCONTROL9)
            {
                return socketClientManager.CheckHamonic_Status(SOCKET_IP9, SOCKET_PORT9, command, itemName);
            }
            else if (itemName == ITEMCONTROL10)
            {
                return socketClientManager.CheckHamonic_Status(SOCKET_IP10, SOCKET_PORT10, command, itemName);
            }
            else if (itemName == ITEMCONTROL11)
            {
                return socketClientManager.CheckHamonic_Status(SOCKET_IP11, SOCKET_PORT11, command, itemName);
            }
            else if (itemName == ITEMCONTROL12)
            {
                return socketClientManager.CheckHamonic_Status(SOCKET_IP12, SOCKET_PORT12, command, itemName);
            }
            else if (itemName == ITEMCONTROL13)
            {
                return socketClientManager.CheckHamonic_Status(SOCKET_IP13, SOCKET_PORT13, command, itemName);
            }
            else if (itemName == ITEMCONTROL14)
            {
                return socketClientManager.CheckHamonic_Status(SOCKET_IP14, SOCKET_PORT14, command, itemName);
            }
            else if (itemName == ITEMCONTROL15)
            {
                return socketClientManager.CheckHamonic_Status(SOCKET_IP15, SOCKET_PORT15, command, itemName);
            }
            else if (itemName == ITEMCONTROL16)
            {
                return socketClientManager.CheckHamonic_Status(SOCKET_IP16, SOCKET_PORT16, command, itemName);
            }
            else
                return 0;
        }
